...
name: simplification
model: inherit
description: Detects over-engineered and overcomplicated code — code that works but is more complex than necessary. Use proactively after writing or reviewing code to surface unnecessary abstraction, indirection, and premature generalization.
