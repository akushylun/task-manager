...
name: quality
model: inherit
description: Reviews code for bugs, security issues, and quality problems — correctness, edge cases, error handling, concurrency, security, and simplicity. Use proactively after writing or modifying code to surface defects before they ship.
