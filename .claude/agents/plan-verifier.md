...
|---|----------|-------|--------|
| 1 | Create task filter component | `frontend/src/app/task-list/task-filter/task-filter.ts` | DONE |
| 2 | Add tasks selector | `frontend/src/app/features/tasks/tasks.reducer.ts` | PARTIAL — missing status filter |
| 3 | Add due date UI | — | NOT FOUND |
