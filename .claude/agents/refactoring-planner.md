...
Also load the domain-specific skill:
...
**Lines:** [count] | **Services injected:** [count] | **Subscriptions:** [count] | **@Input/@Output:** [count]
...
| Extract one service from component | `FormStateService` extracted | Yes |
| Rename file and update imports | `list.component.ts` → `blog-list.component.ts` | Yes |
| Extract service + rename + split | Three changes at once | **No** |
