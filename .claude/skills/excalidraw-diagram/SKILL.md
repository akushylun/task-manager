...
*Example*: Grouping by responsibility (UI / Data / Integration), by phase (Setup / Execution / Cleanup), or by team (User / System / External)

### Level 3: Detail Inside Sections
Evidence artifacts, code snippets, and concrete examples within each section. This is where the educational value lives.

*Example*: Inside an "Integration" section, you might show the actual API response format, not just a box labeled "API Response"
