...
Use for API flows, service interactions, and request/response patterns. Ideal for documenting HTTP interceptor chains, component communication, and client-API flows.
...
Use for data models, interfaces, and object relationships.
...
Use for data model relationships, API schema documentation.
